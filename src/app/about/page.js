    ...
    <main className="bg-white text-slate-800">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-[#05223f] to-[#0f7b86]">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <motion.div variants={fade("up", 24)} initial="hidden" animate="show" className="max-w-3xl">
            ...
            <p className="mt-4 text-sky-50/90 text-justify">
      ...
      <section className="mx-auto max-w-7xl grid items-start gap-14 px-6 py-20 md:grid-cols-2">
        ...
        <motion.div
          ...
          className="relative h-[450px] overflow-hidden rounded-2xl border border-slate-100 shadow"
        >
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <h2 className="text-[2rem] font-semibold text-[#0F2742]">Founder — Vishal N Shah</h2>
          <p className="text-slate-700 text-[17px] text-justify leading-relaxed">
      ...
      <section className="mx-auto max-w-7xl grid items-start gap-14 px-6 pb-20 md:grid-cols-2">
        ...
        >
          <h2 className="text-[2rem] font-semibold text-[#0F2742]">Co-Founder — Nishant S Chitalia</h2>
          <p className="text-slate-700 text-[17px] text-justify leading-relaxed">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true, amount: 0.3 }}
          className="relative h-[450px] overflow-hidden rounded-2xl border border-slate-100 shadow order-1 md:order-2"
        >
      ...
      {/* DARK VARIANT — Mission & Vision Cards */}
      <section className="bg-[#0e2f5b] py-16 md:py-20">
        <motion.div
        ...
        >
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-2 text-sky-300 max-w-2xl mx-auto">
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-2">
            ...
            <motion.article
              ...
              whileHover={{ translateY: -8, boxShadow: "0 22px 50px rgba(0,0,0,0.4)" }}
              className="relative rounded-2xl overflow-hidden bg-gradient-to-b from-[#0A2D45] to-[#0F445D] border border-white/10 p-7 md:p-9"
            >
              <div className="flex items-start gap-5">
                <div className="flex h-20 w-20 items-center justify-center rounded-xl bg-white/10 backdrop-blur-md ring-1 ring-white/20 shadow">
                  <IconMission className="h-10 w-10 text-teal-300" />
                </div>

                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-white">Our Mission</h3>
                  <p className="mt-3 text-sky-200 leading-relaxed">
                  ...
                  <ul className="mt-4 space-y-2 text-sm text-sky-300 leading-relaxed">
            ...
            >
              <div className="flex items-start gap-5">
                <div className="flex h-20 w-20 items-center justify-center rounded-xl bg-white/10 backdrop-blur-md ring-1 ring-white/20 shadow">
                  <IconVision className="h-10 w-10 text-teal-300" />
                </div>
